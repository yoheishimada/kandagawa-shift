...
st.session_state["plan_latest_prices"] = latest_prices
st.session_state["plan_start_date"]    = start_date
st.session_state["plan_mode_label"]    = mode_label

if st.button("生産計画表を開く →", use_container_width=True, type="primary"):
